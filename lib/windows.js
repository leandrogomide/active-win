...
function windows() {
	...
	// Change in favor of using iconv-lite
	// Remove trailing null characters	
	let windowTitle = iconvlite.decode(windowTextBuffer, "utf16");
	windowTitle = windowTitle.replace(/\0+$/g, '');	
	...
	// Change in favor of using iconv-lite
	// Remove trailing null characters
	let processPath = iconvlite.decode(processFileNameBuffer, 'utf16');
	processPath = processPath.replace(/\0+$/g, '');
